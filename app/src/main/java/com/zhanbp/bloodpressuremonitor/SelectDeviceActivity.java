...
public class SelectDeviceActivity extends Activity implements View.OnClickListener {
    ...
    private ArrayList<String> selectDeviceNames;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectDeviceNames = new ArrayList<>();
        initView();
        initEvent();
        initBle();
    }
    ...
    private void initBle() {
        ...
        scanManager.setScanCallbackCompat(new ScanCallbackCompat() {
            ...
            public void onScanResult(int callbackType, ScanResultCompat result) {
                ...
                if (!deviceMacs.contains(result.getDevice().getAddress()) & result.getDevice().getName()!= null) {
    ...
    private void initView() {
        ...
        adapter = new ScanDeviceAdapter(deviceNames);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnOk:
                ...
                intent.putExtra("name", selectDeviceNames);
